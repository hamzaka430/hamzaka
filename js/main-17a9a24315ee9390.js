    ...
    [179], {
        ...
        5442: function(e, t, r) {
            ...
            function _(e) {
                ...
                let S = (0, u.useRef)(!1);
                if ((0, u.useEffect)(() => {
                        !S.current && ("afterInteractive" === s ? m(e) : "lazyOnload" === s && ("complete" === document.readyState ? (0, f.requestIdleCallback)(() => m(e)) : window.addEventListener("load", () => {
                            (0, f.requestIdleCallback)(() => m(e))
                        })), S.current = !0)
                            ...
                            if (!c || i || c.includes("__next_data_catchall") || c.includes("/_error") || c.includes("/404") || (i = c), i) {
                                if (i.startsWith("/")) {
                                    ...
                                    return Promise.all([r.router.pageLoader.getPageList(), (0, u.getClientBuildManifest)()]).then(n => {
                                        ...
                                        let s = i.includes(c) ? c : F((0, d.normalizeLocalePath)((0, w.removeBasePath)(t.pathname), r.router.locales).pathname, i);
            ...
            class J {
                ...
                change(e, t, r, a, i) {
                    ...
                    return n._(function*() {
                        ...
                        f._inFlightRoute && f.clc && (X || J.events.emit("routeChangeError", k(), f._inFlightRoute, Z), f.clc(), f.clc = null), r = (0, j.addBasePath)((0, P.addLocale)((0, O.hasBasePath)(r) ? (0, w.removeBasePath)(r) : r, a.locale, f.defaultLocale));
                        ...
                        let ea = r;
                        en = en ? (0, l.removeTrailingSlash)((0, w.removeBasePath)(en)) : en;
                        ...
                        ea = (0, S.removeLocale)((0, w.removeBasePath)(ea), G.locale), ei = (0, l.removeTrailingSlash)(en);
                        let es = !1;
                        ...
                        try {
                            ...
                            if (q || a.shallow || (yield f._bfl(r, "resolvedAs" in n ? n.resolvedAs : void 0, G.locale)), "route" in n && ec) {
                                ...
                                let e = (0, O.hasBasePath)(er.pathname) ? (0, w.removeBasePath)(er.pathname) : er.pathname;
                            ...
                            let S = q && !v && !V && !et && (0, R.compareRouterStates)(b, f.state);
                            if (!S) {
                                try {
                                    yield f.set(b, n, v)
                                } catch (e) {
                    ...
                    return n._(function*() {
                        ...
                        try {
                            ...
                            if (R && ("/_error" === r || "/404" === r) && (R.effect = void 0), g && (R ? R.json = self.__NEXT_DATA__.props : R = {
                                ...
                                }), t(), (null == R ? void 0 : null == (P = R.effect) ? void 0 : P.type) === "redirect-internal" || (null == R ? void 0 : null == (S = R.effect) ? void 0 : S.type) === "redirect-external") return R.effect;
                            if ((null == R ? void 0 : null == (j = R.effect) ? void 0 : j.type) === "rewrite") {
                                ...
                                if ((!g || n.includes(t)) && (e = t, r = R.effect.resolvedHref, a = o._({}, a, R.effect.parsedAs.query), u = (0, w.removeBasePath)((0, d.normalizeLocalePath)(R.effect.parsedAs.pathname, b.locales).pathname), s = b.components[e], c.shallow && s && b.route === e && !p)) return o._({}, s, {
                                    route: e
                                })
                            }
                ...
                constructor(e, t, r, {
                    ...
                    if (this.basePath = "", this.sub = s, this.clc = null, this._wrapApp = i, this.isSsr = !0, this.isLocaleDomain = !1, this.isReady = !!(self.__NEXT_DATA__.gssp || self.__NEXT_DATA__.gip || self.__NEXT_DATA__.appGip && !self.__NEXT_DATA__.gsp || !S && !self.location.search), this.state = {
                            route: P,
                            pathname: e,
                            query: t,
                            asPath: S ? e : r,
        ...
        8018: function(e) {
            var t, r, n, o, a, i, l, u, c, s, f, d, p, h, m, g, y, _, v, b, P, S, w, j, O, E, x, C, R, M, A, L, T, I, N, k, D, B, U, H, F, q, W, z, G, V;
            (t = {}).d = function(e, r) {
