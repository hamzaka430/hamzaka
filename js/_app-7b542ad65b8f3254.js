(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [888], {
        3454: function(t, e, i) {
            "use strict";
            var n, r;
            t.exports = (null == (n = i.g.process) ? void 0 : n.env) && "object" == typeof(null == (r = i.g.process) ? void 0 : r.env) ? i.g.process : i(7663)
        },
        6840: function(t, e, i) {
        ...
        8490: function(t, e, i) {
            ...
            let p = {
                ...
                P = g.reduce((t, e) => {
                    let i = v[e];
                    return t[e] = (t, e = !1, n = !1) => (f || b(), i.schedule(t, e, n)), t
                }, {});
            ...
            class S {
                constructor(t, e = {}) {
                    ...
                    }, this.scheduleVelocityCheck = () => P.postRender(this.velocityCheck), this.velocityCheck = ({
                        timestamp: t
                    }) => {
                        t !== this.lastUpdated && (this.prev = this.current, this.events.velocityChange && this.events.velocityChange.notify(this.getVelocity()))
                    }, this.hasAnimated = !1, this.prev = this.current = t, this.canTrackVelocity = E(this.current), this.owner = e.owner
                }
                onChange(t) {
            ...
            let tR = new Set(["animate", "exit", "variants", "initial", "style", "values", "variants", "transition", "transformTemplate", "transformValues", "custom", "inherit", "onLayoutAnimationStart", "onLayoutAnimationComplete", "onLayoutMeasure", "onBeforeLayoutMeasure", "onAnimationStart", "onAnimationComplete", "onUpdate", "onDragStart", "onDrag", "onDragEnd", "onMeasureDragConstraints", "onDirectionLock", "onDragTransitionEnd", "_dragX", "_dragY", "onHoverStart", "onHoverEnd", "onViewportEnter", "onViewportLeave", "ignoreStrict", "viewport"]);

            function tj(t) {
                return t.startsWith("while") || t.startsWith("drag") && "draggable" !== t || t.startsWith("layout") || t.startsWith("onTap") || t.startsWith("onPan") || tR.has(t)
            }
            let tF = t => !tj(t);
            try {
            ...
            let t_ = t => t.replace(/([a-z])([A-Z])/g, "$1-$2").toLowerCase();
            ...
            function tX(t, e, i, n) {
                for (let i in tz(t, e, void 0, n), e.attrs) t.setAttribute(tH.has(i) ? i : t_(i), e.attrs[i])
            }
            ...
            let t9 = t => e => t3(e) && t(e, t4(e));

            function t6(t, e, i, n) {
                return t2(t, e, t9(i), n)
            }
            let t8 = (t, e) => i => e(t(i)),
                t7 = (...t) => t.reduce(t8);
            ...
            function eo(t, e) {
                let i = "onHover" + (e ? "Start" : "End"),
                    n = (n, r) => {
                        ...
                        let s = t.getProps();
                        t.animationState && s.whileHover && t.animationState.setActive("whileHover", e), s[i] && P.update(() => s[i](n, r))
                    };
            ...
            let ev = "data-" + t_("framerAppearId"),
                ...
                eV = {},
                eE = {};
            for (let t in eA) eE[t] = () => (void 0 === eV[t] && (eV[t] = eA[t]()), eV[t]);
            let eS = (t, e, i) => (((1 - 3 * i + 3 * e) * t + (3 * i - 6 * e)) * t + 3 * e) * t;
            ...
            function eC(t, e, i, n) {
                ...
                let r = e => (function(t, e, i, n, r) {
                    let s, o;
                    let a = 0;
                    do(s = eS(o = e + (i - e) / 2, n, r) - t) > 0 ? i = o : e = o; while (Math.abs(s) > 1e-7 && ++a < 12);
                    return o
                })(e, 0, 1, t, i);
            ...
            let eM = eC(.42, 0, 1, 1),
                ...
                eR = t => e => e <= .5 ? t(2 * e) / 2 : (2 - t(2 * (1 - e))) / 2,
                ej = t => e => 1 - t(1 - e),
                ...
                ez = (t, e) => i => !!(tx(i) && ty.test(i) && i.startsWith(t) || e && Object.prototype.hasOwnProperty.call(i, e)),
                eH = (t, e, i) => n => {
                    if (!tx(n)) return n;
            ...
            function e7(t) {
                ...
                return i.value.includes("var(--") && e8(i, e4), e8(i, e9), e8(i, e6), i
            }
            ...
            function ie(t) {
                ...
                return t => {
                    let e = r;
                    for (let r = 0; r < s; r++) e = r < n ? e.replace(e4.token, t[r]) : r < n + i ? e.replace(e9.token, eK.transform(t[r])) : e.replace(e6.token, tf(t[r]));
                    return e
                }
            }
            ...
            function iV({
                ...
                b();
                let P = iA[r] || ip;
                P !== ip && "number" != typeof n[0] && (g = id([0, 100], n, {
                    clamp: !1
                }), n = [0, 100]);
                let w = P({
                    ...d,
                ...
                let k = 0,
                    ...
                    F = () => {
                        ...
                        f || (f = i(D));
                        let t = f.now();
                        l && l(), null !== A ? V = t - A : V && "finished" !== T || (V = t), E = V, A = null, T = "running", f.start()
                    };
                t && F();
                let B = {
                    then: (t, e) => m.then(t, e),
            ...
            let iE = new Set(["opacity", "clipPath", "filter", "transform", "backgroundColor"]),
                iS = (t, e) => "spring" === e.type || "backgroundColor" === t || ! function t(e) {
                    return !!(!e || "string" == typeof e && eT[e] || eP(e) || Array.isArray(e) && e.every(t))
                }(e.ease),
                iC = {
                    type: "spring",
                    stiffness: 500,
                ...
                iR = (t, e) => "zIndex" !== t && !!("number" == typeof e || Array.isArray(e) || "string" == typeof e && ir.test(e) && !e.startsWith("url(")),
            ...
            let iz = (t, e, i, n = {}) => r => {
                ...
                if (! function({
                        ...
                        ...p,
                        ...iL(t, p)
                    }), p.duration && (p.duration = ey(p.duration)), p.repeatDelay && (p.repeatDelay = ey(p.repeatDelay)), !c || !d || eb.current || !1 === s.type) return function({
                    keyframes: t,
                    delay: e,
                    onUpdate: i,
                    onComplete: n
                ...
                if (e.owner && e.owner.current instanceof HTMLElement && !e.owner.getProps().onUpdate) {
                    let i = function(t, e, {
                        ...
                        let s, o;
                        let a = eE.waapi() && iE.has(e) && !r.repeatDelay && "mirror" !== r.repeatType && 0 !== r.damping && "inertia" !== r.type;
                        if (!a) return !1;
                        let l = !1,
                            u = () => {
                                o = new Promise(t => {
                        ...
                        let m = function(t, e, i, {
                                ...
                                l && (u.offset = l);
                                let h = function t(e) {
                                    if (e) return eP(e) ? ew(e) : Array.isArray(e) ? e.map(t) : eT[e]
                                }(a);
            ...
            function iQ(t, e, {
                ...
                for (let e in a) {
                    ...
                    if (window.HandoffAppearAnimations && !n.hasAnimated) {
                        let i = t.getProps()[ev];
                        i && (o.elapsed = window.HandoffAppearAnimations(i, e, n, P))
                    }
                    n.start(iz(e, n, r, t.shouldReduceMotion && ti.has(e) ? {
                        type: !1
                    } : o));
                    let c = n.animation;
                    iH(l) && (l.add(e), c.then(() => l.remove(e))), u.push(c)
                }
            ...
            class i6 {
                constructor(t, e, {
                    ...
                    if (this.startEvent = null, this.lastMoveEvent = null, this.lastMoveEventInfo = null, this.handlers = {}, this.updatePoint = () => {
                            ...
                            this.lastMoveEvent = t, this.lastMoveEventInfo = i8(e, this.transformPagePoint), P.update(this.updatePoint, !0)
            ...
            function nP(t) {
                return nb(t) || nw(t) || t.z || t.rotate || t.rotateX || t.rotateY
            }
            ...
            class nj {
                ...
                start(t, {
                    ...
                    let n = t => {
                            this.stopAnimation(), e && this.snapToCursor(t4(t, "page").point)
                        },
                        r = (t, e) => {
                            let {
                                drag: i,
                ...
                resolveRefConstraints() {
                    ...
                    let s = function(t, e, i) {
                            ...
                            return r && (nS(n.x, r.offset.x), nS(n.y, r.offset.y)), n
            ...
            class nN extends a.Component {
                ...
                getSnapshotBeforeUpdate(t) {
                    ...
                    return s && (s.isPresent = r, n || t.layoutDependency !== e || void 0 === e ? s.willUpdate() : this.safeToRemove(), t.isPresent === r || (r ? s.promote() : s.relegate() || P.postRender(() => {
                        let t = s.getStack();
            ...
            let n$ = {
                ...
                nH = t => "number" == typeof t || tT.test(t);
                ...
                return class {
                    ...
                    mount(e, i = !1) {
                        ...
                        n && this.root.registerSharedNode(n, this), !1 !== this.options.animate && s && (n || r) && this.addEventListener("didUpdate", ({
                            ...
                            let r = this.options.transition || s.getDefaultTransition() || rb,
                                {
                                    onLayoutAnimationStart: o,
                                    onLayoutAnimationComplete: a
                                } = s.getProps(),
                                l = !this.targetLayout || !n4(this.targetLayout, n) || i,
                                u = !e && i;
                    ...
                    didUpdate() {
                        ...
                        this.isUpdating && (this.isUpdating = !1, this.potentialNodes.size && (this.potentialNodes.forEach(rP), this.potentialNodes.clear()), this.nodes.forEach(rc), this.nodes.forEach(rs), this.nodes.forEach(ro), this.clearAllSnapshots(), v.update.process(p), v.preRender.process(p), v.render.process(p))
                    }
                    clearAllSnapshots() {
                    ...
                    resetTransform() {
                        ...
                        t && (e || nP(this.latestValues) || s) && (r(this.instance, n), this.shouldResetTransform = !1, this.scheduleRender())
                    }
                    measure(t = !0) {
                        var e;
                    ...
                    measurePageBox() {
                        ...
                        return i && (nS(e.x, i.offset.x), nS(e.y, i.offset.y)), e
                    }
                        ...
                        for (let i = 0; i < this.path.length; i++) {
                            ...
                            if (n !== this.root && r && s.layoutScroll) {
                                if (r.isRoot) {
                                    ...
                                    i && (nS(e.x, -i.offset.x), nS(e.y, -i.offset.y))
                                }
                                nS(e.x, r.offset.x), nS(e.y, r.offset.y)
                            }
                        }
                        return e
                    }
                    applyTransform(t, e = !1) {
                        ...
                        for (let t = 0; t < this.path.length; t++) {
                            ...
                            !e && n.options.layoutScroll && n.scroll && n !== n.root && nD(i, {
                                x: -n.scroll.offset.x,
                                y: -n.scroll.offset.y
                            }), nP(n.latestValues) && nD(i, n.latestValues)
                        }
                        return nP(this.latestValues) && nD(i, this.latestValues), i
                    }
                    removeTransform(t) {
                        let e = ng();
                        nK(e, t);
                        ...
                        return nP(this.latestValues) && n5(e, this.latestValues), e
                    }
                    setTargetDelta(t) {
                    ...
                    getClosestProjectingParent() {
                        return !this.parent || nb(this.parent.latestValues) || nw(this.parent.latestValues) ? void 0 : this.parent.isProjecting() ? this.parent : this.parent.getClosestProjectingParent()
                    }
                    isProjecting() {
                                ...
                                if (o) {
                                    ...
                                    for (let a = 0; a < o; a++) {
                                        ...
                                        (!o || !o.style || "contents" !== o.style.display) && (n && r.options.layoutScroll && r.scroll && r !== r.root && nD(t, {
                                            x: -r.scroll.offset.x,
                                            y: -r.scroll.offset.y
                                        }), s && (e.x *= s.x.scale, e.y *= s.y.scale, nV(t, s)), n && nP(r.latestValues) && nD(t, r.latestValues))
                                    }
                                    e.x = nE(e.x), e.y = nE(e.y)
                                }
                        ...
                        this.animationProgress = 0, this.mixTargetDelta = e => {
                            ...
                            rv(o.x, t.x, u), rv(o.y, t.y, u), this.setTargetDelta(o), this.relativeTarget && this.relativeTargetOrigin && this.layout && this.relativeParent && this.relativeParent.layout && (nl(a, this.layout.layoutBox, this.relativeParent.layout.layoutBox), n = this.relativeTarget, l = this.relativeTargetOrigin, ry(n.x, l.x, a.x, u), ry(n.y, l.y, a.y, u), i && n4(this.relativeTarget, i) && (this.isProjectionDirty = !1), i || (i = ng()), nK(i, this.relativeTarget)), h && (this.animationValues = s, function(t, e, i, n, r, s) {
                                ...
                                for (let r = 0; r < n_; r++) {
                                    ...
                                    o || (o = 0), a || (a = 0);
                                    let l = 0 === o || 0 === a || nH(o) === nH(a);
                                    l ? (t[s] = Math.max(eJ(nz(o), nz(a), n), 0), (tw.test(a) || tw.test(o)) && (t[s] += "%")) : t[s] = a
                    ...
                    startAnimation(t) {
                        this.notifyListeners("animationStart"), this.currentAnimation && this.currentAnimation.stop(), this.resumingFrom && this.resumingFrom.currentAnimation && this.resumingFrom.currentAnimation.stop(), this.pendingAnimation && (w(this.pendingAnimation), this.pendingAnimation = void 0), this.pendingAnimation = P.update(() => {
                            Y.hasAnimatedSinceResize = !0, this.currentAnimation = function(t, e, i) {
                                let n = tr(t) ? t : C(t);
                                return n.start(iz("", n, 1e3, i)), n.animation
                            }(0, 0, {
                                ...t,
                                onUpdate: e => {
                    ...
                    getProjectionStyles(t = {}) {
                        ...
                        if (!this.projectionDelta || !this.layout || !s.target) {
                            let e = {};
                            return this.options.layoutId && (e.opacity = void 0 !== this.latestValues.opacity ? this.latestValues.opacity : 1, e.pointerEvents = tQ(t.pointerEvents) || ""), this.hasProjected && !nP(this.latestValues) && (e.transform = r ? r({}, "") : "none", this.hasProjected = !1), e
                        }
                    ...
                    if (!t.resumeFrom) {
                        ...
                        if (n && !n.resumeFrom) {
                            ...
                            if (r && s) {
                                ...
                                let a = ng();
                                nl(a, e, s.layoutBox), n4(o, a) || (u = !0), n.options.layoutRoot && (t.relativeTarget = a, t.relativeTargetOrigin = o, t.relativeParent = n)
                            }
                        }
                    }
            ...
            function rT(t, e, i) {
                return "position" === t || "preserve-aspect" === t && !nn(n9(e), n9(i), .2)
            }
            let rA = rr({
                    ...
                    if (r.forEach(r => {
                            ...
                            if (tZ(d)) {
                                let t = d.length,
                                    e = null === d[0] ? 1 : 0;
                                c = iZ(h = d[e]);
                                for (let i = e; i < t && null !== d[i]; i++) l ? el(iZ(d[i]) === l, "All keyframes must be of the same type") : el((l = iZ(d[i])) === c || rL(c) && rL(l), "Keyframes must be of the same dimension as the current value")
                            } else l = iZ(d);
                            if (c !== l) {
                                if (rL(c) && rL(l)) {
                                    let t = u.get();
            ...
            class rG {
                constructor({
                    ...
                    }, this.scheduleRender = () => P.render(this.render, !1, !0);
                    let {
                        latestValues: o,
                        renderState: a
                    } = r;
                    this.latestValues = o, this.baseTarget = {
                        ...
                        ...o
                    } : {}, this.renderState = a, this.parent = t, this.props = e, this.presenceContext = i, this.depth = t ? t.depth + 1 : 0, this.reducedMotionConfig = n, this.options = s, this.isControllingVariants = W(e), this.isVariantNode = _(e), this.isVariantNode && (this.variantChildren = new Set), this.manuallyAnimateOnMount = !!(t && t.current);
                    let {
                        willChange: l,
                        ...u
                    ...
                    for (let t in u) {
                        let e = u[t];
                        void 0 !== o[t] && tr(e) && (e.set(o[t], !1), iH(l) && l.add(t))
                    }
                }
                ...
                mount(t) {
                    this.current = t, r_.set(t, this), this.projection && this.projection.mount(t), this.parent && this.isVariantNode && !this.isControllingVariants && (this.removeFromVariantTree = this.parent.addVariantChild(this)), this.values.forEach((t, e) => this.bindToMotionValue(e, t)), rW.current || function() {
                        if (rW.current = !0, j) {
                ...
                unmount() {
                    for (let t in r_.delete(this.current), this.projection && this.projection.unmount(), w(this.notifyUpdate), w(this.render), this.valueSubscriptions.forEach(t => t()), this.removeFromVariantTree && this.removeFromVariantTree(), this.parent && this.parent.children.delete(this), this.events) this.events[t].clear();
                ...
                bindToMotionValue(t, e) {
                    let i = ti.has(t),
                        n = e.on("change", e => {
                            this.latestValues[t] = e, this.props.onUpdate && P.update(this.notifyUpdate, !1, !0), i && this.projection && (this.projection.isTransformDirty = !0)
                        }),
                ...
                update(t, e) {
                    ...
                    this.prevMotionValues = function(t, e, i) {
                        ...
                        for (let r in e) {
                            let s = e[r],
                                o = i[r];
                            if (tr(s)) t.addValue(r, s), iH(n) && n.add(r);
            ...
            class rK extends rq {
                ...
                readValueFromInstance(t, e) {
                    ...
                    return e = tH.has(e) ? e : t_(e), t.getAttribute(e)
                }
                                ...
                                super(t), t.animationState || (t.animationState = function(t) {
                                    ...
                                    function s(s, o) {
                                        ...
                                        for (let e = 0; e < i2; e++) {
                                            ...
                                            let b = (p = f.prevProp, "string" == typeof g ? g !== p : !!Array.isArray(g) && !ef(g, p)),
                                                P = b || m === o && f.isActive && !x && v || e > d && v,
                                            ...
                                            for (let t in V) {
                                                let e = T[t],
                                                    i = A[t];
                                                c.hasOwnProperty(t) || (e !== i ? tZ(e) && tZ(i) ? !ef(e, i) || b ? E(t) : f.protectedKeys[t] = !0 : void 0 !== e ? E(t) : h.add(t) : void 0 !== e && h.has(t) ? E(t) : f.protectedKeys[t] = !0)
                                            }
                                            f.prevProp = g, f.prevResolvedValues = T, f.isActive && (c = {
                                                ...c,
                                                ...T
                                            }), n && t.blockInitialAnimation && (P = !1), P && !x && u.push(...w.map(t => ({
                                                animation: t,
                                                options: {
                                                    type: m,
                                                    ...s
                    ...
                    tap: {
                        Feature: class extends es {
                            ...
                            startPress(t, e) {
                                ...
                                n && this.node.animationState && this.node.animationState.setActive("whileTap", !0), i && P.update(() => i(t, e))
                            }
                            checkPressEnd() {
                        ...
                        Feature: class extends es {
                            ...
                            createPanHandlers() {
                                ...
                                return {
                                    ...
                                    onMove: i,
                                    onEnd: (t, e) => {
                                        delete this.session, n && P.update(() => n(t, e))
                                    }
                                }
                            }
                            mount() {
                            ...
                            let s = (0, a.forwardRef)(function(s, o) {
                                ...
                                if (!d && j) {
                                    p.visualElement = function(t, e, i, n) {
                                        let {
                                            visualElement: r
                                        } = (0, a.useContext)(L), s = (0, a.useContext)(B), o = (0, a.useContext)(R), l = (0, a.useContext)(M).reducedMotion, u = (0, a.useRef)();
                    ...
                    return {
                        ...
                        useRender: function(t = !1) {
                            let e = (e, i, n, r, {
                                ...
                                return n && (c["data-projection-id"] = n), (0, a.createElement)(e, {
                                    ...c,
                                    children: p
                                })
                            };
            ...
            let r5 = "G-4FFCWEC2WB",
                r2 = t => {
                    r5 && "development" !== (r1.env.NEXT_PUBLIC_VERCEL_ENV || "production") && window.gtag("config", r5, {
                        page_path: t
                    })
                };
            i(7952);
            ...
            function r9(t) {
                ...
                return (0, r.jsxs)(r.Fragment, {
                    children: ["development" !== (r3.env.NEXT_PUBLIC_VERCEL_ENV || "production") && (0, r.jsxs)(r.Fragment, {
                        children: [(0, r.jsx)(u(), {
                            children: (0, r.jsx)("script", {
                                dangerouslySetInnerHTML: {
                                    __html: "\n              window.dataLayer = window.dataLayer || [];\n              function gtag(){dataLayer.push(arguments);}\n              gtag('js', new Date());\n\n              gtag('config', '".concat(r5, "', {\n                page_path: window.location.pathname,\n              });\n            ")
                                }
                            })
                        }), (0, r.jsx)(c(), {
                            strategy: "afterInteractive",
                            src: "https://www.googletagmanager.com/gtag/js?id=".concat(r5)
                        })]
                    }), (0, r.jsxs)("div", {
            ...
            ! function() {
                var e = {
                        229: function(t) {
                            ...
                            function c() {
                                u && n && (u = !1, n.length ? l = n.concat(l) : h = -1, l.length && d())
                            }
